(() => {
  ...
  return {
    ...
    computed: {
      startTime(){
        return bbn.dt(this.start).mtst;
      },
      endTime(){
        return bbn.dt(this.end).mtst;
      },
      valuesDays(){
        return this.values * DAY_LENGTH;
      },
      minPlus(){
        return bbn.dt(this.startTime + this.valuesDays).sql();
      },
      maxMinus(){
        return bbn.dt(this.endTime - this.valuesDays).sql();
      },
      isDaily(){
